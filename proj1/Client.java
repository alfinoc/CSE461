/*
    ...
    This class performs the four steps of project 1, printing messages
    indicating its progress. For part B, '.' characters are printed for
    each packet sent. When all four steps have finished, secrets a - d
    are printed.
*/
